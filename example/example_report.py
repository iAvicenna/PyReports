...
ssection = pr.ReportSection(1.1, is_subsection=True)
...
#add a list of texts
texts = [pr.ReportText('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin nec lacinia dolor.'),
         pr.ReportText('Morbi augue justo, euismod et ante quis, laoreet congue est. Aliquam erat volutpat.'),
         pr.ReportText('Praesent pharetra magna vel nunc scelerisque interdum.', font_size=30), pr.ReportLink('https://www.lipsum.com/', 'Lipsum generator')]
ssection.add_list(texts)

texts = [pr.ReportText('Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
         pr.ReportText('Vestibulum auctor eleifend commodo.')
         ]
ssection.add_list(texts, is_ordered=True)


#create new section and add a multitab containing an image, a text and a list
section2 = pr.ReportSection(2)
section2.add_section_title('Section 2 (demonstration of multitabs)')
list1 = pr.ReportList([
    pr.ReportText('Lorem ipsum dolor sit amet, consectetur adipiscing elit.'),
    pr.ReportText('Nullam efficitur mattis laoreet. '),
    pr.ReportText(' Maecenas cursus ornare massa, nec eleifend arcu posuere sed.', font_size=4)])
